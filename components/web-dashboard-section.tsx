      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Powerful web-based interfaces designed for different user roles and
            responsibilities
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                For Medical Staff & Emergency Departments
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
                ...
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Direct communication with ambulance crews
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                For System Administrators & Managers
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
                ...
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Hospital and ambulance service coordination
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">
                    Data export and compliance reporting tools
                  </span>
                </li>
              </ul>
            </CardContent>
