      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-center lg:text-left mb-6 max-w-md">
              Transforming emergency care across Sri Lanka through innovative
              technology and seamless communication between ambulances and
              hospitals.
            </p>
          ...
          <div>
            <h3 className="text-lg text-center lg:text-left font-semibold mb-4">
              Quick Links
            </h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} RescueMed. All rights reserved. <br />
