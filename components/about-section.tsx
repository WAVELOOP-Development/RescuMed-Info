export function AboutSection() {
  return (
    <section id="about" className="lg:py-20 py-16 bg-black">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">Revolutionizing Emergency Response</h2>
          <div className="grid md:grid-cols-2 gap-12 text-left">
            <div>
              <h3 className="text-2xl font-semibold text-center lg:text-left text-white mb-4">Our Purpose</h3>
              <p className="text-gray-400 text-center lg:text-left leading-relaxed mb-6">
            ...
            <div>
              <h3 className="text-2xl font-semibold text-center lg:text-left text-white mb-4">Proven Benefits</h3>
              <p className="text-gray-400 text-center lg:text-left leading-relaxed mb-6">
